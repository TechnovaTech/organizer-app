      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(child: _buildActionCard('Profile', Icons.person, Colors.blue)),
                const SizedBox(width: 12),
                Expanded(child: _buildActionCard('Calendar', Icons.calendar_month, Colors.green)),
                const SizedBox(width: 12),
                Expanded(child: _buildActionCard('Portfolio', Icons.photo_library, Colors.purple)),
              ],
            ),
          ],
        ),
